...
if(!process.argv.includes('--portal'))for(const [slug,folder]of demos){
 ...
 await build({configFile:false,root:resolve(root,folder),base,plugins:[adapter,react()],build:{outDir:resolve(root,'dist/demo',slug),emptyOutDir:true},logLevel:'warn'});
